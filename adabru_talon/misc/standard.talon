...
paste: key(ctrl-v)
clipboard: user.system_exec("copyq toggle")
...
switch files: user.switch_app("org.gnome.Nautilus", "nautilus")
...
switch steps: user.switch_app('featherpad', 'sh -c "featherpad -w /home/adabru/👣/*"')
